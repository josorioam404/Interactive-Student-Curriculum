...
class StudentRepository(BaseRepository):
    ...
    def get_curriculum_with_progress(self, user_id: int, program_code: str) -> List[Tuple]:
    ...
    def update_subject_progress(self, user_id: int, subject_code: str, 
                               status: str, final_grade: Optional[float]) -> None:
    ...
    def get_program_subjects_with_prereqs(self, user_id: int, program_code: str) -> List[Tuple]:
