...
from models.responses import (
    StudentCurriculumResponse, ProgressSummaryResponse,
...
@router.get("/available-courses", response_model=AvailableCoursesResponse)
def get_available_courses(user_id: int = Depends(get_current_user_id)):
    """Get courses available for enrollment based on completed prerequisites."""
    return student_service.get_available_courses(user_id)
